...
public class ListAlbumAdapter extends ArrayAdapter<ImageModel> {
    ...
    com.naosteam.slideshowmaker.activities.kessiimagepicker.myinterface.OnListAlbum onListAlbum;
...
//            holder.click.getLayoutParams().height = this.pHeightItem;
    ...
    public com.naosteam.slideshowmaker.activities.kessiimagepicker.myinterface.OnListAlbum getOnListAlbum() {
        return this.onListAlbum;
    }

    public void setOnListAlbum(com.naosteam.slideshowmaker.activities.kessiimagepicker.myinterface.OnListAlbum onListAlbum) {
