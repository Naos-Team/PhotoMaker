package com.kessi.photovideomaker.activities.kessiimagepicker.adapter;
...
public class ListAlbumAdapter extends ArrayAdapter<ImageModel> {
    ...
    com.kessi.photovideomaker.activities.kessiimagepicker.myinterface.OnListAlbum onListAlbum;
...
//            holder.click.getLayoutParams().height = this.pHeightItem;
    ...
    public com.kessi.photovideomaker.activities.kessiimagepicker.myinterface.OnListAlbum getOnListAlbum() {
        return this.onListAlbum;
    }

    public void setOnListAlbum(com.kessi.photovideomaker.activities.kessiimagepicker.myinterface.OnListAlbum onListAlbum) {
