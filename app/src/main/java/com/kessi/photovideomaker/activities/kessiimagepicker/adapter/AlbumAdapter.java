...
public class AlbumAdapter extends ArrayAdapter<ImageModel> {
    ...
    com.kessi.photovideomaker.activities.kessiimagepicker.myinterface.OnAlbum onItem;
...
//        holder.imageItem.setBackground();
    ...
    public com.kessi.photovideomaker.activities.kessiimagepicker.myinterface.OnAlbum getOnItem() {
        return this.onItem;
    }

    public void setOnItem(com.kessi.photovideomaker.activities.kessiimagepicker.myinterface.OnAlbum onItem) {
        this.onItem = onItem;
    }
