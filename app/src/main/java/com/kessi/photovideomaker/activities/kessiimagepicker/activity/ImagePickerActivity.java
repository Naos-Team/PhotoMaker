package com.kessi.photovideomaker.activities.kessiimagepicker.activity;
...
import com.kessi.photovideomaker.activities.kessiimagepicker.Constants;
import com.kessi.photovideomaker.activities.kessiimagepicker.adapter.AlbumAdapter;
import com.kessi.photovideomaker.activities.kessiimagepicker.adapter.ListAlbumAdapter;
import com.kessi.photovideomaker.activities.kessiimagepicker.model.ImageModel;
...
public class ImagePickerActivity extends AppCompatActivity implements OnClickListener, com.kessi.photovideomaker.activities.kessiimagepicker.myinterface.OnAlbum, com.kessi.photovideomaker.activities.kessiimagepicker.myinterface.OnListAlbum {
...
//        getSupportActionBar().setTitle(new File(pathAlbum).getName());
    ...
    public void handlerDoWork(com.kessi.photovideomaker.activities.kessiimagepicker.myinterface.IHandler mIHandler) {
